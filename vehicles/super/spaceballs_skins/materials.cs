singleton Material("super.skin.sb_scuderiabolide_group2")
{
    mapTo = "super.skin.sb_scuderiabolide_group2";
    overlayMap[2] = "vehicles/super/spaceballs_skins/super_skin_scuderiabolide_group2.dds";
